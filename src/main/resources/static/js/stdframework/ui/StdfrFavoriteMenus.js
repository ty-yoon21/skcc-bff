...
class StdfrFavoriteMenus{
    ...
    createFavoritePopup() {
        ...
        el[3].dataset.i18n = "stdframework.cm.favorite.title";          // 즐겨찾기 목록
        ...
        el[5].innerHTML = '닫기';
        el[5].dataset.i18n = "stdframework.core.button.close";       // 닫기
        ...
        el[11].dataset.i18n = "stdframework.cm.favorite.title";       // 즐겨찾기 목록
        ...
        el[15].innerHTML = '삭제';
        el[15].dataset.i18n = "stdframework.core.button.delete";       // 삭제
        ...
        el[20].innerHTML = '저장';
        el[20].dataset.i18n = "stdframework.core.button.save";       // 저장
        ...
        el[21].dataset.i18n = "stdframework.core.button.cancel";       // 취소
    ...
    popupChangeLanguage(lang) {
        ...
        if(i18next?.exists('stdframework.cm.favorite.grid.header.favoriteName')) {
            self.favoriteGrid.columns[1].header = i18next.t('stdframework.cm.favorite.grid.header.favoriteName');
        }
